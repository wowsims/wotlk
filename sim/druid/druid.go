...
func New(char core.Character, form DruidForm, selfBuffs SelfBuffs, talents proto.DruidTalents) *Druid {
	...
	druid.AddStatDependency2(stats.Strength, stats.AttackPower, 2)
	druid.AddStatDependency2(stats.Agility, stats.MeleeCrit, core.CritRatingPerCritChance/25)
	druid.AddStatDependency2(stats.Agility, stats.Dodge, core.DodgeRatingPerDodgeChance/14.7059)
