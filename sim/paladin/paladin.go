...
func NewPaladin(character core.Character, talents proto.PaladinTalents) *Paladin {
	...
	paladin.AddStatDependency2(stats.Strength, stats.AttackPower, 2.0)
	paladin.AddStat(stats.AttackPower, -20)

	// Paladins get 1% crit per 52.08 agil
	paladin.AddStatDependency2(stats.Agility, stats.MeleeCrit, (1.0/52.08)*core.CritRatingPerCritChance)

	// Paladins get 1% dodge per 52.08 agil
	paladin.AddStatDependency2(stats.Agility, stats.Dodge, (1.0/52.08)*core.DodgeRatingPerDodgeChance)
