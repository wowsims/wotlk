...
func (shaman *Shaman) NewSpiritWolf(index int) *SpiritWolf {
	...
	spiritWolf.AddStatDependency2(stats.Strength, stats.AttackPower, 2)
	spiritWolf.AddStatDependency2(stats.Agility, stats.MeleeCrit, core.CritRatingPerCritChance/83.3)
