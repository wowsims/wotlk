...
func (wp *WarlockPet) newShadowBite() *core.Spell {
	...
	return wp.RegisterSpell(core.SpellConfig{
		...
		ApplyEffects: core.ApplyEffectFuncDirectDamage(core.SpellEffect{
			ProcMask: core.ProcMaskSpellDamage,
			DamageMultiplier: (1.0 + 0.03*float64(wp.owner.Talents.ShadowMastery)) * (1 + 0.15*(core.TernaryFloat64(wp.owner.ImmolateDot.IsActive(), 1, 0)+ //core.TernaryFloat64(wp.owner.ConflagrateDot.IsActive(), 1, 0) +
