...
func NewHunter(character core.Character, options proto.Player) *Hunter {
	...
	hunter.AddStatDependency2(stats.Strength, stats.AttackPower, 1)
	hunter.AddStatDependency2(stats.Agility, stats.AttackPower, 1)
	hunter.AddStatDependency2(stats.Agility, stats.RangedAttackPower, 1)
	hunter.AddStatDependency2(stats.Agility, stats.MeleeCrit, core.CritRatingPerCritChance/83.33)
