...
func (priest *Priest) registerDevouringPlagueSpell() {
	...
	priest.DevouringPlagueDot = core.NewDot(core.Dot{
		...
		TickEffects: core.TickFuncSnapshot(target, core.SpellEffect{
			...
			DamageMultiplier:     (1 + float64(priest.Talents.Darkness)*0.02 + float64(priest.Talents.TwinDisciplines)*0.01 + float64(priest.Talents.ImprovedDevouringPlague)*0.05 + core.TernaryFloat64(priest.HasSetBonus(ItemSetConquerorSanct, 2), 1.15/8, 1)),
