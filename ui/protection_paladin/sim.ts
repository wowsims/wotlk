		...
		super(parentElem, player, {
			...
			defaults: {
				...
				epWeights: Stats.fromMap({
					[Stat.StatArmor]: 0.05,
					[Stat.StatStamina]: 1.00,
					[Stat.StatStrength]: 1.00,
					[Stat.StatAgility]: 0.66,
					[Stat.StatAttackPower]: 0.24,
					[Stat.StatExpertise]: 0.69,
					[Stat.StatMeleeHit]: 0.55,
					[Stat.StatMeleeCrit]: 0.26,
					[Stat.StatMeleeHaste]: 0.09,
					[Stat.StatArmorPenetration]: 0.03,
					[Stat.StatSpellPower]: 0.10,
					[Stat.StatBlock]: 0.40,
					[Stat.StatBlockValue]: 0.32,
					[Stat.StatDodge]: 0.36,
					[Stat.StatParry]: 0.40,
					[Stat.StatDefense]: 0.50,
				}),
