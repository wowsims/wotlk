...
export declare type DeathKnightSpecs = [Spec.SpecDeathKnight, Spec.SpecDeathKnightTank];
...
export declare type SpecTalents<T extends Spec> = T extends Spec.SpecBalanceDruid ? DruidTalents : T extends Spec.SpecElementalShaman ? ShamanTalents : T extends Spec.SpecEnhancementShaman ? ShamanTalents : T extends Spec.SpecFeralDruid ? DruidTalents : T extends Spec.SpecFeralTankDruid ? DruidTalents : T extends Spec.SpecHunter ? HunterTalents : T extends Spec.SpecMage ? MageTalents : T extends Spec.SpecRogue ? RogueTalents : T extends Spec.SpecRetributionPaladin ? PaladinTalents : T extends Spec.SpecProtectionPaladin ? PaladinTalents : T extends Spec.SpecShadowPriest ? PriestTalents : T extends Spec.SpecWarlock ? WarlockTalents : T extends Spec.SpecWarrior ? WarriorTalents : T extends Spec.SpecProtectionWarrior ? WarriorTalents : T extends Spec.SpecSmitePriest ? PriestTalents : T extends Spec.SpecDeathKnight ? DeathKnightTalents : T extends Spec.SpecDeathKnightTank ? DeathKnightTalents : ShamanTalents;
